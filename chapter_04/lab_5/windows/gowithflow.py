...
def merge_and_sort(list_data_a, list_data_b):
    ...
    list_data_a.extend(list_data_b)
    list_data_a.sort()
    result = list_data_a
...
def comparison_list_size(list_data_a, list_data_b):
    ...
    if len(list_data_a) > len(list_data_b):
        result = list_data_a
    elif len(list_data_a) < len(list_data_b):
        result = list_data_b
    else:
        result = list_data_a
...
def number_of_cases(list_data):
    ...
    #   >>> a = [1, 2, 3, 'a']
    #   >>> gwf.number_of_cases(a)
    #   ['11', '12', '13', '1a', '21', '22', '23', '2a', '31',
    #   '32', '33', '3a', 'a1', 'a2', 'a3', 'aa']
    # '''
    # ===Modify codes below=============
    # 한 줄 이상의 코드로 작성 가능하나,
    # 반드시 결과 값을 result 변수에 할당하여 반환
    ...
    for element in list_data:
        for i in range(len(list_data)):
            case = str(element) + str(list_data[i])
