...
def is_duplicated_number(three_digit):
    ...
    for i in three_digit:
        set_three_digit.add(i)
    if len(set_three_digit) == 3:
        result = False
    else:
        result = True
    # ==================================
...
def is_validated_number(user_input_number):
    ...
    if is_digit(user_input_number) is False:
        result = False
    elif is_between_100_and_999(user_input_number) is True and\
            is_duplicated_number(user_input_number) is False:
        result = True
    else:
        result = False
    # ==================================
...
def get_not_duplicated_three_digit_number():
    ...
    random_number = '999'
    while is_duplicated_number(random_number) is True:
...
def main():
    ...
    while 1:
        ...
        while sb[0] != 3:
            ...
            print('Strikes : {} , Balls : {}'.format(sb[0], sb[1]))
        if user_input == '0':
            break

        while 1:
            one_coin = input('You win, one more(Y/N) ?')
            if is_yes(one_coin) is True:
                break
            elif is_no(one_coin) is True:
                break
            else:
                print('Wrong Input, Input again')
                pass
        if is_no(one_coin) is True:
            break
    # ==================================
